...
const deathMoreFiveDatabase = database.filter(function(element, index) {
...
// const deathMoreFiveDatabaseOnlyProvince = deathMoreFiveDatabase.map(function(element, index) {
//     return ({
//         province: element.province,
//         total_death: element.total_death
//     })
// })
console.log(deathMoreFiveDatabase)
